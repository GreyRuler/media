...
/* harmony import */ var _ModalCustom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ModalCustom */ "./src/js/ModalCustom.js");
...
class Chat {
  ...
  registerEvents() {
    const messageInput = this.container.querySelector(Chat.selectorMessageChat);
    const chat = this.container.querySelector(Chat.selectorMessagesChat);
    messageInput.addEventListener('keyup', async event => {
      if (event.key === 'Enter') {
        ...
        const message = new _Message__WEBPACK_IMPORTED_MODULE_0__["default"](messageContainer, sendMessage);
        message.bindToDOM();
  ...
  getLocation() {
    return new Promise(resolve => {
      navigator.geolocation.getCurrentPosition(data => {
        ...
        const modal = new _ModalCustom__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector(_ModalCustom__WEBPACK_IMPORTED_MODULE_1__["default"].selectorModal));
        modal.show();
...
class Message {
  ...
  bindToDOM() {
    ...
    const text = this.container.querySelector(Message.selectorText);
    const coords = this.container.querySelector(Message.selectorCoords);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ ModalCustom; }
/* harmony export */ });
...
class ModalCustom extends (bootstrap_js_dist_modal__WEBPACK_IMPORTED_MODULE_0___default()) {
  ...
  constructor(element, options) {
    ...
    this.coordinatesInput = this._element.querySelector(ModalCustom.selectorCoordinates);
    this.saveBtn = this._element.querySelector(ModalCustom.selectorSaveBtn);
    this.registerEvents();
  }
  registerEvents() {
...
class Root {
  ...
  static init() {
    ...
    const chat = new _Chat__WEBPACK_IMPORTED_MODULE_0__["default"](this.chatContainer);
    chat.init();
  }
}
...
_Root__WEBPACK_IMPORTED_MODULE_0__["default"].init();
...
/* harmony import */ var _css_scrollbar_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./css/scrollbar.css */ "./src/css/scrollbar.css");
